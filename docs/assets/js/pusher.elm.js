...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {au: fragment, az: host, aG: path, aI: port_, aL: protocol, aM: query};
	});
...
var $author$project$Pusher$ReturnChannelData = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Pusher$ChannelNameUtil$buildChannelQueryUrl = F2(
	function (baseUrl, code) {
		return _Utils_ap(
			...
			A2(
				...
				_List_fromArray(
					[
						A2($elm$url$Url$Builder$string, 'channel_name', code)
					])));
	});
var $author$project$Pusher$Dto$ChannelData = F3(
	function (id, content, created_at) {
		return {g: content, bb: created_at, M: id};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Pusher$Dto$channelDataDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Pusher$Dto$ChannelData,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'content', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'created_at', $elm$json$Json$Decode$string));
var $author$project$Pusher$channelNameLength = 9;
...
var $author$project$Pusher$Dto$initValueDecoder = A3(
	...
	$author$project$Pusher$Dto$InitValue,
	A2($elm$json$Json$Decode$field, 'cpsyc_url', $elm$json$Json$Decode$string),
...
var $author$project$Pusher$ChannelNameUtil$allNumber = $elm$core$Set$fromList(
	_List_fromArray(
		['1', '2', '3', '4', '5', '6', '7', '8', '9', '0']));
...
var $author$project$Pusher$ChannelNameUtil$isNumber = function (c) {
	return A2($elm$core$Set$member, c, $author$project$Pusher$ChannelNameUtil$allNumber);
};
var $elm$core$String$foldr = _String_foldr;
var $elm$core$String$toList = function (string) {
	return A3($elm$core$String$foldr, $elm$core$List$cons, _List_Nil, string);
};
var $author$project$Pusher$ChannelNameUtil$pickoutNumber = function (code) {
	return $elm$core$String$fromList(
		A2(
			$elm$core$List$filter,
			$author$project$Pusher$ChannelNameUtil$isNumber,
			$elm$core$String$toList(code)));
};
var $author$project$Pusher$init = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Pusher$Dto$initValueDecoder, flags);
	if (!_v0.$) {
		var initValue = _v0.a;
...
var $author$project$Pusher$NoOp = {$: 0};
var $author$project$Pusher$RemoteContentUpdated = function (a) {
	return {$: 9, a: a};
};
var $author$project$Pusher$SocketIdAcquired = function (a) {
	return {$: 8, a: a};
};
var $author$project$Pusher$Tick = function (a) {
	return {$: 6, a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Pusher$confirmations = _Platform_incomingPort('confirmations', $elm$json$Json$Decode$bool);
...
var $author$project$Pusher$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Pusher$confirmations(
				function (_v1) {
					return $author$project$Pusher$NoOp;
				}),
				$author$project$Pusher$socketIdAcquired($author$project$Pusher$SocketIdAcquired),
				$author$project$Pusher$remoteContentUpdated(
				function (v) {
					return $author$project$Pusher$RemoteContentUpdated(
						A2($elm$json$Json$Decode$decodeValue, $author$project$Pusher$Dto$remoteContentUpdateEventDecoder, v));
				}),
				A2($elm$time$Time$every, 1000, $author$project$Pusher$Tick)
			]));
};
var $author$project$Pusher$PostContentReturn = function (a) {
	return {$: 7, a: a};
};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Pusher$askForConfirmation = _Platform_outgoingPort(
	'askForConfirmation',
	function ($) {
...
var $author$project$Pusher$channelNameExamplePattern = '345-332-828';
...
var $author$project$Pusher$ChannelNameUtil$httpErrorToString = function (err) {
	switch (err.$) {
		case 0:
			var url = err.a;
			return 'BadUrl: ' + url;
...
var $author$project$Pusher$ChannelNameUtil$insertDash = F2(
	function (toDash, step) {
		var right = A2($elm$core$String$dropLeft, step, toDash);
		var left = A2($elm$core$String$left, step, toDash);
		return $elm$core$String$isEmpty(right) ? left : (left + ('-' + A2($author$project$Pusher$ChannelNameUtil$insertDash, right, step)));
	});
...
var $author$project$Pusher$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
			...
			case 1:
				return _Utils_Tuple2(
					model,
					$author$project$Pusher$askForConfirmation(0));
			case 2:
				var code = msg.a;
				var allNumberCode = $author$project$Pusher$ChannelNameUtil$pickoutNumber(code);
				return _Utils_eq(
					$elm$core$String$length(allNumberCode),
			...
			case 3:
				...
				if (!rcn.$) {
					var cd = rcn.a;
					var isCurrentChannelNameEmpty = $author$project$Pusher$Model$isChannelNameEmpty(model);
					var isChannelNameFromServerSuccess = _Utils_eq(
						$author$project$Pusher$ChannelNameUtil$pickoutNumber(cd.M),
						cd.M);
					var _v2 = _Utils_Tuple2(isCurrentChannelNameEmpty, isChannelNameFromServerSuccess);
					if (!_v2.b) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
			...
			case 6:
				var newTime = msg.a;
				return (!_Utils_eq(model.O, model.g)) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{O: model.g, _: newTime}),
					$elm$http$Http$post(
...
var $author$project$Pusher$DoClicked = {$: 4};
var $author$project$Pusher$EnteringChannelName = function (a) {
	return {$: 2, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Connect to an existing channel by entering the code. OR, Click the Do to request a new channel.')
					])),
				A2(
